  ...
  return (
    !segments.includes("create") && (
      <>
        ...
        <div
          className={`transform ${
            showSidebar ? "transtone-x-0 w-full" : "-transtone-x-full"
          } sm:transtone-x-0 fixed z-10 flex h-full flex-col justify-between border-r border-stone-200 bg-stone-100 p-4 transition-all sm:w-60 dark:border-stone-700 dark:bg-stone-900`}
        >
