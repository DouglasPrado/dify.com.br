  ...
  return (
    <SearchBox
      ...
      classNames={{
        ...
        form: "relative",
        input:
          "ring-black border border-stone-200 focus:outline-none focus:ring-0 flex relative justify-between px-12 gap-3 bg-stone-50 dark:bg-white items-center rounded-lg py-3 w-full",
        submitIcon:
