  ...
  return (
    <div className="border-b pb-6">
      <input
        ...
        className="relative flex w-full items-center justify-between gap-3 rounded-lg border border-stone-200 bg-stone-50 px-3 py-3 ring-black focus:outline-none focus:ring-0 dark:bg-white"
