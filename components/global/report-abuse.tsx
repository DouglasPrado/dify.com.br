...
export default function ReportAbuse() {
  ...
  return (
    <div className="fixed bottom-5 right-5">
      <button
        className="hover:-translate-y-1 active:translate-y-0 rounded-full bg-black p-4 text-white shadow-lg transition-all hover:shadow-2xl active:shadow-sm"
      ...
      {open && (
        ...
        >
          <div>
            <h2 className="font-title text-xl leading-7 text-stone-900">
              Report Abuse
            </h2>
