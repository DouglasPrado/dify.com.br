...
import { deleteReference } from "@/lib/actions/reference";
...
export default function DeleteReferenceForm({ name }: { name: string }) {
  const { referenceId } = useParams() as { referenceId: string };
    ...
    >
      <div className="relative flex flex-col space-y-4 p-5 sm:p-10">
        ...
        <p className="text-sm text-stone-500 dark:text-stone-400">
          Exclui seu negócio e todas os produtos, conteúdos associadas a ele.
          Digite o nome do seu negócio <b>{name}</b> para confirmar.
        </p>
