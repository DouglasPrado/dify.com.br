  ...
  return (
    ...
    >
      <div className="relative flex flex-col space-y-4 p-5 sm:p-10">
        <h2 className="font-title text-xl dark:text-white">Deletar produto</h2>
        <p className="text-sm text-stone-500 dark:text-stone-400">
          Exclui seu produto permanentemente. Digite o nome do seu produto{" "}
          <b>{productName}</b> para confirmar.
        </p>
