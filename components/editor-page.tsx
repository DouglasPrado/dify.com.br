...
export default function EditorPage({ page }: { page: PageWithSite }) {
  ...
  return (
    <div className="relative min-h-[500px] w-full max-w-screen-lg  p-12 px-8 dark:border-stone-700 sm:mb-[calc(20vh)] sm:rounded-lg sm:px-12">
