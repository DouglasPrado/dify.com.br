    ...
    <main className="grid place-items-center pb-8 pt-16 md:pb-24 md:pt-12 lg:grid-cols-2">
      ...
      <div>
        ...
        <div className="mt-6 flex flex-col gap-3 sm:flex-row">
          ...
          >
            <div className="hover:translate-y-1 flex w-full items-center justify-center gap-1 rounded-lg bg-[#25D366] py-1 font-title text-white shadow-xl transition-all">
