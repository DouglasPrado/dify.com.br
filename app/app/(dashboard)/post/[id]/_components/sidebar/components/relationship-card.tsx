...
export default function RelationshipCard() {
  ...
  return (
    <div className="flex items-center justify-between gap-3">
      ...
      />
      <div>
        <h4 className="font-cal text-xs text-stone-800">Postagem 01 </h4>
        <p className="line-clamp-3 text-xs text-stone-500">
          Acesse o guia de exemplos de descrição de produtos e
          modelos editáveis. Edite com as informações das suas mercadorias.
          Baixe os templates grátis!
        </p>
      </div>
