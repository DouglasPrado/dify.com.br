...
export default function CollectionCard() {
  return (
    <div className="flex items-center justify-between gap-3">
      ...
      />
      <div>
        <h4 className="font-cal text-xs text-stone-800">Coleção 01</h4>
      ...
      <button className="flex h-[40px] w-[40px] items-center rounded-full border p-2">
        <Plus width={32} className="text-stone-600" />
      </button>
    </div>
  );
}
