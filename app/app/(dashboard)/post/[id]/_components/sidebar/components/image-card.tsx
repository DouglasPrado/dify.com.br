  ...
  return (
    <div className="flex w-full flex-col rounded-lg bg-stone-100 shadow-none shadow-stone-200 drop-shadow-md transition-all hover:shadow-xl">
      ...
      <div className="relative flex h-[150px]">
        <span className="absolute bottom-0 right-0 m-2 rounded bg-white px-3 py-0.5 text-xs text-stone-700 shadow-lg">
          {data.type}
        </span>
        <Image
          alt=""
      ...
      <div className="flex h-6 w-full justify-between p-4">
