  ...
  return (
    <div
      ...
      className={cn(
        ...
        "hover:-translate-y-1 relative flex cursor-pointer items-center space-x-4 rounded-lg border px-4  py-3 transition-all hover:border-stone-900 hover:text-stone-700",
      )}
    >
