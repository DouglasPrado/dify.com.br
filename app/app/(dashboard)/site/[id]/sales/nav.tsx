...
import { LinkIcon, PocketKnife, ShoppingBag, UsersRound } from "lucide-react";
  ...
  const navItems = [
    {
      name: "Produtos",
      description:
        "Adicione novos produtos à plataforma para apresentar suas ofertas aos clientes. Isso permitirá que os clientes descubram e explorem seus produtos, impulsionando a visibilidade e as oportunidades de venda. ",
