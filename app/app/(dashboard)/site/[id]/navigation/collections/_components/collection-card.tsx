...
export default function CollectionCard({ data }: { data: Collection & any }) {
  return (
    <Link href={`/collection/${data.id}`}>
      <div className="hover:-translate-y-1 flex items-center justify-between gap-3 rounded-lg border border-stone-100 bg-white pr-3 shadow transition-all duration-200 hover:shadow-md">
        <Image
          alt=""
          width={80}
          height={70}
          className="h-[80px] w-[100px] rounded-bl-lg rounded-tl-lg object-cover"
          src={
            data.image! ||
        ...
        <div className="flex w-full flex-col py-2">
          <h4 className="font-cal text-xs text-stone-600">{data.name}</h4>
