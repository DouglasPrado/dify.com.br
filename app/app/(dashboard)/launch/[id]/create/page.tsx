import { TypeForm } from "@/components/form/launch/type-form";
            ...
            <div className="grid grid-cols-1 items-center justify-between lg:flex lg:flex-row">
              <div className="flex flex-col">
                <h1 className="font-cal text-2xl">
                  Vamos iniciar o agendamento em massa?
                </h1>
                <p className="flex">
                  Qual o tipo de agendamento você deseja fazer? Você pode criar
                  artigos, posts para instagram e twitter.
                </p>
              </div>
            </div>
            <TypeForm data={data} />
