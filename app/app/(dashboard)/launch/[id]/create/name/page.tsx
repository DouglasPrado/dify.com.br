import { NameForm } from "@/components/form/launch/name-form";
            ...
            <div className="grid grid-cols-1 items-center justify-between lg:flex lg:flex-row">
              <div className="flex flex-col">
                <h1 className="font-cal text-2xl">
                  Faça a identificação do seu agendamento
                </h1>
                <p className="flex">
                  Primeiro vamos identificar o agendamento, adicione um texto
                  para entender sobre o contexto do conteúdo.
                </p>
              </div>
            </div>
            <NameForm data={data}/>
