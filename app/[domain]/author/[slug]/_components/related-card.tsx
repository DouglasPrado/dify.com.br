...
export default function RelatedCard({ data }: BlogCardProps) {
  return (
    <Link href={`/${data.slug}`}>
      <div className="hover:-transform-y-1 flex items-center justify-between gap-3 rounded-lg border bg-white pr-3 shadow-md transition-all duration-200 hover:shadow-lg">
        <Image
          alt=""
          width={70}
          height={70}
          className="h-[70px] w-[100px] rounded-bl-lg rounded-tl-lg object-cover"
          src={
            data.image! ||
