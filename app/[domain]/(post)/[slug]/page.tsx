            ...
            <div className="flex w-full flex-col gap-3">
              {collections.map(
                (
                  ...
                  <Link
                    className="hover:-transtone-y-1 flex w-full items-center justify-between gap-2 rounded  p-4 text-sm capitalize text-stone-700 transition-all duration-200 hover:bg-stone-100"
                    href={`/`}
