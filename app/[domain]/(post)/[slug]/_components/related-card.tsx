...
export default function RelatedCard({ data }: BlogCardProps) {
  return (
    <Link href={`/${data.slug}`}>
      <div className="hover:-translate-y-1 flex items-center justify-between gap-3  rounded-lg bg-white pr-3 shadow-md transition-all duration-200 hover:shadow-lg">
        <Image
          alt=""
          width={70}
          height={70}
