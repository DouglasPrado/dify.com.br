                    ...
                    {products.length > 0 &&
                      products.map((product: any, idxProduct: number) => (
                        <Link
                          ...
                          className=""
                        >
                          <div className="ease hover:-translate-y-1 h-full overflow-hidden rounded-2xl border-2 border-stone-100 bg-white shadow-md transition-all duration-200 hover:shadow-xl dark:border-stone-800">
